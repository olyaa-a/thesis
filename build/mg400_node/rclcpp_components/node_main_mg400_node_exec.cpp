...
#define NODE_MAIN_LOGGER_NAME "mg400_node_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmg400_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mg400_node::MG400Node>";
