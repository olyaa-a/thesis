...
#define NODE_MAIN_LOGGER_NAME "teleop_twist_joy_node_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libp9n_node_teleop_twist_joy_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<p9n_node::TeleopTwistJoyNode>";
