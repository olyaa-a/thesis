...
#define NODE_MAIN_LOGGER_NAME "p9n_test_node_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libp9n_test_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<p9n_test::PlayStationTestNode>";
