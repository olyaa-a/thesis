...
#define NODE_MAIN_LOGGER_NAME "mg400_joy_interface_node_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmg400_joy_interface_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mg400_joy::MG400JoyInterfaceNode>";
