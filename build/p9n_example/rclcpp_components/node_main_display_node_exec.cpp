...
#define NODE_MAIN_LOGGER_NAME "display_node_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdisplay_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<p9n_example::DisplayNode>";
