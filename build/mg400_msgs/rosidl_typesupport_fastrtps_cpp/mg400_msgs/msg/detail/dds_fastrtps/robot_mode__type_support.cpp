...
#include "mg400_msgs/msg/detail/robot_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mg400_msgs::msg::RobotMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mg400_msgs::msg::RobotMode & ros_message)
{
  // Member: robot_mode
  cdr >> ros_message.robot_mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs::msg::RobotMode;
    is_plain =
      (
      offsetof(DataType, robot_mode) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const mg400_msgs::msg::RobotMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mg400_msgs::msg::RobotMode *>(
    untyped_ros_message);
...
{
  return &mg400_msgs::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, msg, RobotMode)() {
  return &mg400_msgs::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
