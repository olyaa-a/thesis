...
#include "mg400_msgs/srv/detail/get_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mg400_msgs::srv::GetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mg400_msgs::srv::GetPose_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs::srv::GetPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::GetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mg400_msgs::srv::GetPose_Request *>(
    untyped_ros_message);
...
static size_t _GetPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetPose_Request(full_bounded, is_plain, 0);
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_GetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, GetPose_Request)() {
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_GetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mg400_msgs
cdr_serialize(
  const mg400_msgs::srv::GetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: error_id
  ...
  // Member: pose3
  cdr << ros_message.pose3;
  // Member: pose4
  cdr << ros_message.pose4;
  // Member: pose5
  cdr << ros_message.pose5;
  // Member: pose6
  cdr << ros_message.pose6;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mg400_msgs::srv::GetPose_Response & ros_message)
{
  // Member: error_id
  cdr >> ros_message.error_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: pose1
  {
    size_t item_size = sizeof(ros_message.pose1);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: pose2
  {
    size_t item_size = sizeof(ros_message.pose2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: pose3
  {
    size_t item_size = sizeof(ros_message.pose3);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: pose4
  {
    size_t item_size = sizeof(ros_message.pose4);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: pose5
  {
    size_t item_size = sizeof(ros_message.pose5);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: pose6
  {
    size_t item_size = sizeof(ros_message.pose6);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mg400_msgs::srv::GetPose_Response;
    is_plain =
      (
      offsetof(DataType, pose6) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::GetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mg400_msgs::srv::GetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _GetPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetPose_Response(full_bounded, is_plain, 0);
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_GetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, GetPose_Response)() {
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_GetPose_Response__handle;
}
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_GetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, GetPose)() {
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_GetPose__handle;
}
