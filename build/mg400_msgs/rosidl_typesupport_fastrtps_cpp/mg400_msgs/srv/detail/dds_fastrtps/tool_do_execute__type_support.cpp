...
#include "mg400_msgs/srv/detail/tool_do_execute__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mg400_msgs::msg::ToolDOIndex &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mg400_msgs::msg::ToolDOIndex &);
...
cdr_serialize(
  const mg400_msgs::srv::ToolDOExecute_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mg400_msgs::srv::ToolDOExecute_Request & ros_message)
{
  // Member: index
  ...
  size_t current_alignment)
{
  ...
  // Member: index
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mg400_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ToolDOIndex(
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs::srv::ToolDOExecute_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::ToolDOExecute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mg400_msgs::srv::ToolDOExecute_Request *>(
    untyped_ros_message);
...
static size_t _ToolDOExecute_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ToolDOExecute_Request(full_bounded, is_plain, 0);
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_ToolDOExecute_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, ToolDOExecute_Request)() {
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_ToolDOExecute_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mg400_msgs
cdr_serialize(
  const mg400_msgs::srv::ToolDOExecute_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mg400_msgs::srv::ToolDOExecute_Response & ros_message)
{
  // Member: result
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mg400_msgs::srv::ToolDOExecute_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::ToolDOExecute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mg400_msgs::srv::ToolDOExecute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _ToolDOExecute_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ToolDOExecute_Response(full_bounded, is_plain, 0);
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_ToolDOExecute_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, ToolDOExecute_Response)() {
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_ToolDOExecute_Response__handle;
}
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_ToolDOExecute__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, ToolDOExecute)() {
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_ToolDOExecute__handle;
}
