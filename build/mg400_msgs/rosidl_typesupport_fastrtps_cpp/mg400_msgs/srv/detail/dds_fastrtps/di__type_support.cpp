...
#include "mg400_msgs/srv/detail/di__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: index
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mg400_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DIIndex(
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs::srv::DI_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::DI_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mg400_msgs::srv::DI_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DI_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::DI_Request *>(
...
static size_t _DI_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DI_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DI_Request__callbacks = {
  "mg400_msgs::srv",
  "DI_Request",
...
static rosidl_message_type_support_t _DI_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DI_Request__callbacks,
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_DI_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mg400_msgs::srv::DI_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::DI_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mg400_msgs::srv::DI_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DI_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mg400_msgs::srv::DI_Response *>(
...
static size_t _DI_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DI_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DI_Response__callbacks = {
  "mg400_msgs::srv",
  "DI_Response",
...
static rosidl_message_type_support_t _DI_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DI_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_DI_Response__handle;
}
...
static service_type_support_callbacks_t _DI__callbacks = {
  "mg400_msgs::srv",
  "DI",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, DI_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, DI_Response)(),
...
static rosidl_service_type_support_t _DI__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DI__callbacks,
...
{
  return &mg400_msgs::srv::typesupport_fastrtps_cpp::_DI__handle;
}
