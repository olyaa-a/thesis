...
{
  new (message_memory) mg400_msgs::msg::User(_init);
}

void User_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mg400_msgs::msg::User *>(message_memory);
  typed_message->~User();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember User_message_member_array[1] = {
  {
    "user",  // name
    ...
    offsetof(mg400_msgs::msg::User, user),  // bytes offset in struct
...
{
  return &::mg400_msgs::msg::rosidl_typesupport_introspection_cpp::User_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, msg, User)() {
  return &::mg400_msgs::msg::rosidl_typesupport_introspection_cpp::User_message_type_support_handle;
}
