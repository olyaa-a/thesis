...
{
  new (message_memory) mg400_msgs::srv::SpeedL_Request(_init);
}

void SpeedL_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mg400_msgs::srv::SpeedL_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SpeedL_Request_message_member_array[1] = {
  {
    ...
    offsetof(mg400_msgs::srv::SpeedL_Request, r),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SpeedL_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(mg400_msgs::srv::SpeedL_Request),
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_introspection_cpp::SpeedL_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, SpeedL_Request)() {
  return &::mg400_msgs::srv::rosidl_typesupport_introspection_cpp::SpeedL_Request_message_type_support_handle;
}
...
void SpeedL_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) mg400_msgs::srv::SpeedL_Response(_init);
}

void SpeedL_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mg400_msgs::srv::SpeedL_Response *>(message_memory);
  typed_message->~SpeedL_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SpeedL_Response_message_member_array[2] = {
  {
    "result",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mg400_msgs::srv::SpeedL_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mg400_msgs::srv::SpeedL_Response, error_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SpeedL_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(mg400_msgs::srv::SpeedL_Response),
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_introspection_cpp::SpeedL_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, SpeedL_Response)() {
  return &::mg400_msgs::srv::rosidl_typesupport_introspection_cpp::SpeedL_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SpeedL_service_members = {
  ...
  // see get_service_type_support_handle<mg400_msgs::srv::SpeedL>()
...
get_service_type_support_handle<mg400_msgs::srv::SpeedL>()
{
  ...
  auto service_type_support =
    &::mg400_msgs::srv::rosidl_typesupport_introspection_cpp::SpeedL_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, SpeedL)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<mg400_msgs::srv::SpeedL>();
}
