...
mg400_msgs__msg__DistanceMode__create()
{
  ...
  mg400_msgs__msg__DistanceMode * msg = (mg400_msgs__msg__DistanceMode *)allocator.allocate(sizeof(mg400_msgs__msg__DistanceMode), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__msg__DistanceMode));
  bool success = mg400_msgs__msg__DistanceMode__init(msg);
  if (!success) {
...
mg400_msgs__msg__DistanceMode__destroy(mg400_msgs__msg__DistanceMode * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mg400_msgs__msg__DistanceMode__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
mg400_msgs__msg__DistanceMode__Sequence__init(mg400_msgs__msg__DistanceMode__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__msg__DistanceMode * data = NULL;

  if (size) {
    data = (mg400_msgs__msg__DistanceMode *)allocator.zero_allocate(size, sizeof(mg400_msgs__msg__DistanceMode), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__msg__DistanceMode__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mg400_msgs__msg__DistanceMode__fini(&data[i - 1]);
      }
...
mg400_msgs__msg__DistanceMode__Sequence__fini(mg400_msgs__msg__DistanceMode__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__msg__DistanceMode__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__msg__DistanceMode__Sequence * array = (mg400_msgs__msg__DistanceMode__Sequence *)allocator.allocate(sizeof(mg400_msgs__msg__DistanceMode__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__msg__DistanceMode__Sequence__init(array, size);
  if (!success) {
...
mg400_msgs__msg__DistanceMode__Sequence__destroy(mg400_msgs__msg__DistanceMode__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__msg__DistanceMode__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__msg__DistanceMode__Sequence__are_equal(const mg400_msgs__msg__DistanceMode__Sequence * lhs, const mg400_msgs__msg__DistanceMode__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__msg__DistanceMode__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__msg__DistanceMode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__msg__DistanceMode);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__msg__DistanceMode * data =
      (mg400_msgs__msg__DistanceMode *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__msg__DistanceMode__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__msg__DistanceMode__fini(&output->data[i]);
        }
        return false;
      }
    }
