...
mg400_msgs__action__MovLIO_Goal__init(mg400_msgs__action__MovLIO_Goal * msg)
{
  ...
  if (!geometry_msgs__msg__PoseStamped__init(&msg->pose)) {
    mg400_msgs__action__MovLIO_Goal__fini(msg);
    return false;
  }
  // mode
...
mg400_msgs__action__MovLIO_Goal__create()
{
  ...
  mg400_msgs__action__MovLIO_Goal * msg = (mg400_msgs__action__MovLIO_Goal *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_Goal));
  bool success = mg400_msgs__action__MovLIO_Goal__init(msg);
  if (!success) {
...
mg400_msgs__action__MovLIO_Goal__Sequence__init(mg400_msgs__action__MovLIO_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Goal * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_Goal *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_Goal__fini(&data[i - 1]);
      }
...
mg400_msgs__action__MovLIO_Goal__Sequence__fini(mg400_msgs__action__MovLIO_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Goal__Sequence * array = (mg400_msgs__action__MovLIO_Goal__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_Goal__Sequence__init(array, size);
  if (!success) {
...
mg400_msgs__action__MovLIO_Goal__Sequence__destroy(mg400_msgs__action__MovLIO_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_Goal__Sequence__are_equal(const mg400_msgs__action__MovLIO_Goal__Sequence * lhs, const mg400_msgs__action__MovLIO_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_Goal * data =
      (mg400_msgs__action__MovLIO_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_Goal__copy(
...
mg400_msgs__action__MovLIO_Result__init(mg400_msgs__action__MovLIO_Result * msg)
{
  ...
  if (!mg400_msgs__msg__ErrorID__init(&msg->error_id)) {
    mg400_msgs__action__MovLIO_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Result * msg = (mg400_msgs__action__MovLIO_Result *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_Result));
  bool success = mg400_msgs__action__MovLIO_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_Result__Sequence__init(mg400_msgs__action__MovLIO_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Result * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_Result *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mg400_msgs__action__MovLIO_Result__Sequence__fini(mg400_msgs__action__MovLIO_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Result__Sequence * array = (mg400_msgs__action__MovLIO_Result__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_Result__Sequence__destroy(mg400_msgs__action__MovLIO_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_Result__Sequence__are_equal(const mg400_msgs__action__MovLIO_Result__Sequence * lhs, const mg400_msgs__action__MovLIO_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_Result * data =
      (mg400_msgs__action__MovLIO_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mg400_msgs__action__MovLIO_Feedback__init(mg400_msgs__action__MovLIO_Feedback * msg)
{
  ...
  if (!geometry_msgs__msg__PoseStamped__init(&msg->current_pose)) {
    mg400_msgs__action__MovLIO_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Feedback * msg = (mg400_msgs__action__MovLIO_Feedback *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_Feedback));
  bool success = mg400_msgs__action__MovLIO_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_Feedback__Sequence__init(mg400_msgs__action__MovLIO_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Feedback * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_Feedback *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mg400_msgs__action__MovLIO_Feedback__Sequence__fini(mg400_msgs__action__MovLIO_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_Feedback__Sequence * array = (mg400_msgs__action__MovLIO_Feedback__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_Feedback__Sequence__destroy(mg400_msgs__action__MovLIO_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_Feedback__Sequence__are_equal(const mg400_msgs__action__MovLIO_Feedback__Sequence * lhs, const mg400_msgs__action__MovLIO_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_Feedback * data =
      (mg400_msgs__action__MovLIO_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mg400_msgs__action__MovLIO_SendGoal_Request__init(mg400_msgs__action__MovLIO_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mg400_msgs__action__MovLIO_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!mg400_msgs__action__MovLIO_Goal__init(&msg->goal)) {
    mg400_msgs__action__MovLIO_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
mg400_msgs__action__MovLIO_SendGoal_Request__fini(mg400_msgs__action__MovLIO_SendGoal_Request * msg)
{
  ...
  // goal
  mg400_msgs__action__MovLIO_Goal__fini(&msg->goal);
}
...
mg400_msgs__action__MovLIO_SendGoal_Request__are_equal(const mg400_msgs__action__MovLIO_SendGoal_Request * lhs, const mg400_msgs__action__MovLIO_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!mg400_msgs__action__MovLIO_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_SendGoal_Request * msg = (mg400_msgs__action__MovLIO_SendGoal_Request *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_SendGoal_Request));
  bool success = mg400_msgs__action__MovLIO_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_SendGoal_Request__Sequence__init(mg400_msgs__action__MovLIO_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_SendGoal_Request * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_SendGoal_Request *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mg400_msgs__action__MovLIO_SendGoal_Request__Sequence__fini(mg400_msgs__action__MovLIO_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_SendGoal_Request__Sequence * array = (mg400_msgs__action__MovLIO_SendGoal_Request__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_SendGoal_Request__Sequence__destroy(mg400_msgs__action__MovLIO_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_SendGoal_Request__Sequence__are_equal(const mg400_msgs__action__MovLIO_SendGoal_Request__Sequence * lhs, const mg400_msgs__action__MovLIO_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_SendGoal_Request * data =
      (mg400_msgs__action__MovLIO_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mg400_msgs__action__MovLIO_SendGoal_Response__init(mg400_msgs__action__MovLIO_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    mg400_msgs__action__MovLIO_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_SendGoal_Response * msg = (mg400_msgs__action__MovLIO_SendGoal_Response *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_SendGoal_Response));
  bool success = mg400_msgs__action__MovLIO_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_SendGoal_Response__Sequence__init(mg400_msgs__action__MovLIO_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_SendGoal_Response * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_SendGoal_Response *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mg400_msgs__action__MovLIO_SendGoal_Response__Sequence__fini(mg400_msgs__action__MovLIO_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_SendGoal_Response__Sequence * array = (mg400_msgs__action__MovLIO_SendGoal_Response__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_SendGoal_Response__Sequence__destroy(mg400_msgs__action__MovLIO_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_SendGoal_Response__Sequence__are_equal(const mg400_msgs__action__MovLIO_SendGoal_Response__Sequence * lhs, const mg400_msgs__action__MovLIO_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_SendGoal_Response * data =
      (mg400_msgs__action__MovLIO_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mg400_msgs__action__MovLIO_GetResult_Request__init(mg400_msgs__action__MovLIO_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mg400_msgs__action__MovLIO_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_GetResult_Request * msg = (mg400_msgs__action__MovLIO_GetResult_Request *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_GetResult_Request));
  bool success = mg400_msgs__action__MovLIO_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_GetResult_Request__Sequence__init(mg400_msgs__action__MovLIO_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_GetResult_Request * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_GetResult_Request *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mg400_msgs__action__MovLIO_GetResult_Request__Sequence__fini(mg400_msgs__action__MovLIO_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_GetResult_Request__Sequence * array = (mg400_msgs__action__MovLIO_GetResult_Request__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_GetResult_Request__Sequence__destroy(mg400_msgs__action__MovLIO_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_GetResult_Request__Sequence__are_equal(const mg400_msgs__action__MovLIO_GetResult_Request__Sequence * lhs, const mg400_msgs__action__MovLIO_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_GetResult_Request * data =
      (mg400_msgs__action__MovLIO_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mg400_msgs__action__MovLIO_GetResult_Response__init(mg400_msgs__action__MovLIO_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!mg400_msgs__action__MovLIO_Result__init(&msg->result)) {
    mg400_msgs__action__MovLIO_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
mg400_msgs__action__MovLIO_GetResult_Response__fini(mg400_msgs__action__MovLIO_GetResult_Response * msg)
{
  ...
  // status
  // result
  mg400_msgs__action__MovLIO_Result__fini(&msg->result);
}
...
mg400_msgs__action__MovLIO_GetResult_Response__are_equal(const mg400_msgs__action__MovLIO_GetResult_Response * lhs, const mg400_msgs__action__MovLIO_GetResult_Response * rhs)
{
  ...
  // result
  if (!mg400_msgs__action__MovLIO_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_GetResult_Response * msg = (mg400_msgs__action__MovLIO_GetResult_Response *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_GetResult_Response));
  bool success = mg400_msgs__action__MovLIO_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_GetResult_Response__Sequence__init(mg400_msgs__action__MovLIO_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_GetResult_Response * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_GetResult_Response *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mg400_msgs__action__MovLIO_GetResult_Response__Sequence__fini(mg400_msgs__action__MovLIO_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_GetResult_Response__Sequence * array = (mg400_msgs__action__MovLIO_GetResult_Response__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_GetResult_Response__Sequence__destroy(mg400_msgs__action__MovLIO_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_GetResult_Response__Sequence__are_equal(const mg400_msgs__action__MovLIO_GetResult_Response__Sequence * lhs, const mg400_msgs__action__MovLIO_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_GetResult_Response * data =
      (mg400_msgs__action__MovLIO_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mg400_msgs__action__MovLIO_FeedbackMessage__init(mg400_msgs__action__MovLIO_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mg400_msgs__action__MovLIO_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!mg400_msgs__action__MovLIO_Feedback__init(&msg->feedback)) {
    mg400_msgs__action__MovLIO_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
mg400_msgs__action__MovLIO_FeedbackMessage__fini(mg400_msgs__action__MovLIO_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  mg400_msgs__action__MovLIO_Feedback__fini(&msg->feedback);
}
...
mg400_msgs__action__MovLIO_FeedbackMessage__are_equal(const mg400_msgs__action__MovLIO_FeedbackMessage * lhs, const mg400_msgs__action__MovLIO_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!mg400_msgs__action__MovLIO_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_FeedbackMessage * msg = (mg400_msgs__action__MovLIO_FeedbackMessage *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mg400_msgs__action__MovLIO_FeedbackMessage));
  bool success = mg400_msgs__action__MovLIO_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_FeedbackMessage__Sequence__init(mg400_msgs__action__MovLIO_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_FeedbackMessage * data = NULL;

  if (size) {
    data = (mg400_msgs__action__MovLIO_FeedbackMessage *)allocator.zero_allocate(size, sizeof(mg400_msgs__action__MovLIO_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mg400_msgs__action__MovLIO_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mg400_msgs__action__MovLIO_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mg400_msgs__action__MovLIO_FeedbackMessage__Sequence__fini(mg400_msgs__action__MovLIO_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mg400_msgs__action__MovLIO_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mg400_msgs__action__MovLIO_FeedbackMessage__Sequence * array = (mg400_msgs__action__MovLIO_FeedbackMessage__Sequence *)allocator.allocate(sizeof(mg400_msgs__action__MovLIO_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mg400_msgs__action__MovLIO_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mg400_msgs__action__MovLIO_FeedbackMessage__Sequence__destroy(mg400_msgs__action__MovLIO_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mg400_msgs__action__MovLIO_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mg400_msgs__action__MovLIO_FeedbackMessage__Sequence__are_equal(const mg400_msgs__action__MovLIO_FeedbackMessage__Sequence * lhs, const mg400_msgs__action__MovLIO_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mg400_msgs__action__MovLIO_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mg400_msgs__action__MovLIO_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mg400_msgs__action__MovLIO_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mg400_msgs__action__MovLIO_FeedbackMessage * data =
      (mg400_msgs__action__MovLIO_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mg400_msgs__action__MovLIO_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mg400_msgs__action__MovLIO_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mg400_msgs__action__MovLIO_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
