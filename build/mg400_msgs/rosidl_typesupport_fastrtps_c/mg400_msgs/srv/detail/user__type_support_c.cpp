...
#include "mg400_msgs/srv/detail/user__rosidl_typesupport_fastrtps_c.h"
...
#include "mg400_msgs/msg/detail/user__functions.h"  // user

// forward declare type support functions
size_t get_serialized_size_mg400_msgs__msg__User(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_mg400_msgs__msg__User(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mg400_msgs, msg, User)();


using _User_Request__ros_msg_type = mg400_msgs__srv__User_Request;
  ...
  // Field name: user
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mg400_msgs, msg, User
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->user, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_mg400_msgs__srv__User_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _User_Request__ros_msg_type * ros_message = static_cast<const _User_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_mg400_msgs__msg__User(
...
static uint32_t _User_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mg400_msgs__srv__User_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mg400_msgs
size_t max_serialized_size_mg400_msgs__srv__User_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: user
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mg400_msgs__msg__User(
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs__srv__User_Request;
    is_plain =
      (
...
static size_t _User_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mg400_msgs__srv__User_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mg400_msgs, srv, User_Request)() {
...
using _User_Response__ros_msg_type = mg400_msgs__srv__User_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mg400_msgs
size_t get_serialized_size_mg400_msgs__srv__User_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _User_Response__ros_msg_type * ros_message = static_cast<const _User_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mg400_msgs__srv__User_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mg400_msgs
size_t max_serialized_size_mg400_msgs__srv__User_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mg400_msgs__srv__User_Response;
    is_plain =
      (
...
static size_t _User_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mg400_msgs__srv__User_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mg400_msgs, srv, User_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mg400_msgs, srv, User)() {
  return &User__handle;
}
