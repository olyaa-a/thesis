...
#include "mg400_msgs/srv/detail/speed_factor__rosidl_typesupport_fastrtps_c.h"
...
using _SpeedFactor_Request__ros_msg_type = mg400_msgs__srv__SpeedFactor_Request;
...
size_t get_serialized_size_mg400_msgs__srv__SpeedFactor_Request(
  const void * untyped_ros_message,
...
static uint32_t _SpeedFactor_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mg400_msgs__srv__SpeedFactor_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mg400_msgs
size_t max_serialized_size_mg400_msgs__srv__SpeedFactor_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs__srv__SpeedFactor_Request;
    is_plain =
      (
...
static size_t _SpeedFactor_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mg400_msgs__srv__SpeedFactor_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mg400_msgs, srv, SpeedFactor_Request)() {
...
using _SpeedFactor_Response__ros_msg_type = mg400_msgs__srv__SpeedFactor_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mg400_msgs
size_t get_serialized_size_mg400_msgs__srv__SpeedFactor_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SpeedFactor_Response__ros_msg_type * ros_message = static_cast<const _SpeedFactor_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mg400_msgs__srv__SpeedFactor_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mg400_msgs
size_t max_serialized_size_mg400_msgs__srv__SpeedFactor_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mg400_msgs__srv__SpeedFactor_Response;
    is_plain =
      (
...
static size_t _SpeedFactor_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mg400_msgs__srv__SpeedFactor_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mg400_msgs, srv, SpeedFactor_Response)() {
...
// already included above
// #include "mg400_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "mg400_msgs/srv/speed_factor.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mg400_msgs, srv, SpeedFactor)() {
