...
#include "mg400_msgs/msg/detail/user__rosidl_typesupport_fastrtps_c.h"
...
using _User__ros_msg_type = mg400_msgs__msg__User;
  ...
  void * untyped_ros_message)
{
  ...
  _User__ros_msg_type * ros_message = static_cast<_User__ros_msg_type *>(untyped_ros_message);
  // Field name: user
  {
    cdr >> ros_message->user;
  }
...
static uint32_t _User__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mg400_msgs__msg__User(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs__msg__User;
    is_plain =
      (
...
static size_t _User__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mg400_msgs__msg__User(
