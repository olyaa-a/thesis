...
#include "mg400_msgs/msg/detail/tool__rosidl_typesupport_fastrtps_c.h"
...
using _Tool__ros_msg_type = mg400_msgs__msg__Tool;
...
static uint32_t _Tool__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mg400_msgs__msg__Tool(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mg400_msgs__msg__Tool;
    is_plain =
      (
...
static size_t _Tool__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mg400_msgs__msg__Tool(
