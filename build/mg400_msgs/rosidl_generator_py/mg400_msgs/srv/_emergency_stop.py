...
class Metaclass_EmergencyStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mg400_msgs.srv import _emergency_stop
...
class EmergencyStop(metaclass=Metaclass_EmergencyStop):
    from mg400_msgs.srv._emergency_stop import EmergencyStop_Request as Request
    from mg400_msgs.srv._emergency_stop import EmergencyStop_Response as Response
