...
bool mg400_msgs__srv__do__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mg400_msgs.srv._do.DO_Request", full_classname_dest, 29) == 0);
  }
  mg400_msgs__srv__DO_Request * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of DO_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mg400_msgs.srv._do");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DO_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool mg400_msgs__srv__do__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mg400_msgs.srv._do.DO_Response", full_classname_dest, 30) == 0);
  }
  mg400_msgs__srv__DO_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of DO_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mg400_msgs.srv._do");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DO_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
