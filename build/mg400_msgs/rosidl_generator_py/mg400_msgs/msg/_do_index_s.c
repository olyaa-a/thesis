...
bool mg400_msgs__msg__do_index__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mg400_msgs.msg._do_index.DOIndex", full_classname_dest, 32) == 0);
  }
  mg400_msgs__msg__DOIndex * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of DOIndex */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mg400_msgs.msg._do_index");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DOIndex");
