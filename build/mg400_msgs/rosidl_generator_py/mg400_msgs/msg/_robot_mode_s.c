...
bool mg400_msgs__msg__robot_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mg400_msgs.msg._robot_mode.RobotMode", full_classname_dest, 36) == 0);
  }
  mg400_msgs__msg__RobotMode * ros_message = _ros_message;
  {  // robot_mode
    ...
    ros_message->robot_mode = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * mg400_msgs__msg__robot_mode__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mg400_msgs.msg._robot_mode");
  ...
  {  // robot_mode
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->robot_mode);
    {
