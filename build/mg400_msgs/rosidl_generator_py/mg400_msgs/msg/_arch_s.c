...
bool mg400_msgs__msg__arch__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mg400_msgs.msg._arch.Arch", full_classname_dest, 25) == 0);
  }
  mg400_msgs__msg__Arch * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of Arch */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mg400_msgs.msg._arch");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Arch");
