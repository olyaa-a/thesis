...
bool mg400_msgs__msg__id_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mg400_msgs.msg._id_array.IDArray", full_classname_dest, 32) == 0);
  }
  mg400_msgs__msg__IDArray * ros_message = _ros_message;
  {  // ids
...
{
  /* NOTE(esteve): Call constructor of IDArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mg400_msgs.msg._id_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IDArray");
