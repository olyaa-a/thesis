...
static const _MoveJog_Request_type_support_symbol_names_t _MoveJog_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, MoveJog_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, MoveJog_Request)),
  }
};
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_cpp::MoveJog_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mg400_msgs, srv, MoveJog_Request)() {
  return get_message_type_support_handle<mg400_msgs::srv::MoveJog_Request>();
}
...
static const _MoveJog_Response_type_support_symbol_names_t _MoveJog_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, MoveJog_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, MoveJog_Response)),
  }
};
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_cpp::MoveJog_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mg400_msgs, srv, MoveJog_Response)() {
  return get_message_type_support_handle<mg400_msgs::srv::MoveJog_Response>();
}
...
static const _MoveJog_type_support_symbol_names_t _MoveJog_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, MoveJog)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, MoveJog)),
  }
};
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_cpp::MoveJog_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, mg400_msgs, srv, MoveJog)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<mg400_msgs::srv::MoveJog>();
}
