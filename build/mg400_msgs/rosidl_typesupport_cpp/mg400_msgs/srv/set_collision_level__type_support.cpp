...
static const _SetCollisionLevel_Request_type_support_symbol_names_t _SetCollisionLevel_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, SetCollisionLevel_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, SetCollisionLevel_Request)),
  }
};
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_cpp::SetCollisionLevel_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mg400_msgs, srv, SetCollisionLevel_Request)() {
  return get_message_type_support_handle<mg400_msgs::srv::SetCollisionLevel_Request>();
}
...
static const _SetCollisionLevel_Response_type_support_symbol_names_t _SetCollisionLevel_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, SetCollisionLevel_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, SetCollisionLevel_Response)),
  }
};
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_cpp::SetCollisionLevel_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mg400_msgs, srv, SetCollisionLevel_Response)() {
  return get_message_type_support_handle<mg400_msgs::srv::SetCollisionLevel_Response>();
}
...
static const _SetCollisionLevel_type_support_symbol_names_t _SetCollisionLevel_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mg400_msgs, srv, SetCollisionLevel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mg400_msgs, srv, SetCollisionLevel)),
  }
};
...
{
  return &::mg400_msgs::srv::rosidl_typesupport_cpp::SetCollisionLevel_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, mg400_msgs, srv, SetCollisionLevel)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<mg400_msgs::srv::SetCollisionLevel>();
}
